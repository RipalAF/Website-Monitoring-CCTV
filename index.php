    ...
    <nav class="bg-blue-600 p-4 text-white">    
        <div class="container mx-auto flex justify-between items-center">
            ...
            <ul class="flex space-x-4">
                ...
                <li><a href="logout.php" class="hover:underline">Logout</a></li> <!-- Tombol Logout -->
            </ul>
        </div>
    </nav>
...
<div id="paginationControls" class="flex justify-center space-x-2 mt-8">
    <!-- Tombol Previous -->
    <button id="prevPage" class="flex items-center justify-center bg-blue-500 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
    ...
    <!-- Tombol Next -->
    <button id="nextPage" class="flex items-center justify-center bg-blue-500 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
        onclick="changePage(1)">
...
// Pastikan kategori pertama kali ditampilkan
showCategory(currentCategory, currentPage);
    </script>
</body>
</html>
